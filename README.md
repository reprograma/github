GIT e GITHUB
E um pouquinho de linha de comando
...
 Comandos para usar uma vez na vida: (assim o git sabe quem está fazendo as alterações) git config --global user.name “Patricia Tonella" git config --global user.email “patricia.tonella@gmail.com”
